...
class JetEngineCPTImport {
	...
	function set_jet_engine_cpt_values($header_array ,$value_array , $map, $post_id , $type , $mode, $hash_key){
		$post_values = [];
		$helpers_instance = ImportHelpers::getInstance();
		$post_values = $helpers_instance->get_header_values($map , $header_array , $value_array);
		$this->jet_engine_cpt_import_function($post_values,$type, $post_id, $mode, $hash_key);
	}
	function set_jet_engine_cpt_rf_values($header_array ,$value_array , $map, $post_id , $type , $mode, $hash_key){
		$post_values = [];
		$helpers_instance = ImportHelpers::getInstance();
		$post_values = $helpers_instance->get_header_values($map , $header_array , $value_array);
		$this->jet_engine_cpt_rf_import_function($post_values,$type, $post_id, $mode, $hash_key);
	}

	public function jet_engine_cpt_import_function($data_array, $type, $pID ,$mode, $hash_key) 
	{
	...
	public function jet_engine_cpt_rf_import_function($data_array, $type, $pID ,$mode, $hash_key) 
	{
		$media_instance = MediaHandling::getInstance();
